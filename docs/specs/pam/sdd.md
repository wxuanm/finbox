...
- The chart return axis should use the current visible period's values with compact integer, evenly spaced ticks, avoiding excessive vertical blank space on short periods such as `1M`.
