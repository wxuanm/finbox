...
- Keep historical trend Y-axis bounds based on the current visible returns plus modest padding, avoiding excessive blank space on short periods such as `1M`.
