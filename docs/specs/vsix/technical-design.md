...
- Opens the native VS Code Settings FinBox extension filter for configuration edits instead of implementing custom TreeView form controls.
...
SETTINGS TreeView
  ...
  -> Native VS Code Settings opens at @ext:finx.finbox
```
